export default {
  ...
  probableSquad: {
    goalkeepers: [
      ...
      { name: 'Mostafa Shobeir', club: 'Al Ahly', caps: 6 },
      { name: 'El-Mahdy Soliman', club: 'Zamalek', caps: 3 },
      { name: 'Mohamed Alaa', club: 'Al Gouna', caps: 2 },
    ],
    defenders: [
      { name: 'Mohamed Abdel-Moneim', club: 'Nice', caps: 30 },
      { name: 'Mohamed Hany', club: 'Al Ahly', caps: 35 },
      { name: 'Yasser Ibrahim', club: 'Al Ahly', caps: 20 },
      { name: 'Ramy Rabia', club: 'Al Ain', caps: 15 },
      ...
      { name: 'Karim Hafez', club: 'Pyramids FC', caps: 14 },
    ],
    midfielders: [
      { name: 'Mohamed Salah', club: 'Liverpool', caps: 100 },
      { name: 'Mahmoud Trezeguet', club: 'Al Ettifaq', caps: 68 },
      { name: 'Ahmed Sayed Zizo', club: 'Al Ahly', caps: 45 },
      { name: 'Emmam Ashour', club: 'Al Ahly', caps: 22 },
      { name: 'Ibrahim Adel', club: 'Al Ahly', caps: 16 },
      { name: 'Hamdi Fathy', club: 'Al Wakrah', caps: 15 },
      { name: 'Marwan Attia', club: 'Al Ahly', caps: 10 },
      { name: 'Haitham Hassan', club: 'Pyramids FC', caps: 8 },
      { name: 'Mohannad Lashin', club: 'Al Ahly', caps: 6 },
      { name: 'Mostafa Abdel-Raouf', club: 'Pyramids FC', caps: 6 },
      { name: 'Nabil Emad Donga', club: 'Zamalek', caps: 4 },
      { name: 'Mahmoud Saber', club: 'Zamalek', caps: 3 },
    ],
    forwards: [
