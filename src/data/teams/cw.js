export default {
  ...
  probableSquad: {
    ...
    defenders: [
      ...
      { name: 'Deveron Fonville', club: 'NEC Nijmegen', caps: 12 },
    ],
    midfielders: [
      ...
      { name: 'Ar\'Jany Martha', club: 'Rotherham United', caps: 8 },
      { name: 'Tyrese Noslin', club: 'Telstar', caps: 6 },
    ],
    forwards: [
      { name: 'Gervane Kastaneer', club: 'Terengganu FC', caps: 32 },
      { name: 'Jürgen Locadia', club: 'Miami FC', caps: 18 },
      { name: 'Tahith Chong', club: 'Sheffield United', caps: 10 },
      { name: 'Sontje Hansen', club: 'Middlesbrough', caps: 9 },
      { name: 'Kenji Gorré', club: 'Maccabi Haifa', caps: 14 },
      { name: 'Brandley Kuwas', club: 'FC Volendam', caps: 30 },
      { name: 'Jeremy Antonisse', club: 'AE Kifisia', caps: 5 },
