export default {
  ...
  probableSquad: {
    ...
    defenders: [
      { name: 'Chancel Mbemba', club: 'Lille', caps: 75 },
      { name: 'Axel Tuanzebe', club: 'Burnley', caps: 18 },
      { name: 'Aaron Wan-Bissaka', club: 'West Ham United', caps: 14 },
      { name: 'Arthur Masuaku', club: 'Lens', caps: 20 },
      { name: 'Joris Kayembe', club: 'Genk', caps: 22 },
      { name: 'Dylan Batubinsika', club: 'Larissa', caps: 14 },
      { name: 'Gédéon Kalulu', club: 'Aris Limassol', caps: 4 },
      { name: 'Steve Kapuadi', club: 'Widzew Łódź', caps: 7 },
      { name: 'Aaron Tshibola', club: 'Kilmarnock', caps: 6 },
    ],
    midfielders: [
      { name: 'Samuel Moutoussamy', club: 'Atromitos', caps: 22 },
      { name: 'Edo Kayembe', club: 'Watford', caps: 26 },
      { name: 'Noah Sadiki', club: 'Sunderland', caps: 17 },
      { name: 'Charles Pickel', club: 'Espanyol', caps: 24 },
      { name: 'Gaël Kakuta', club: 'Larissa', caps: 12 },
      { name: 'Ngal\'ayel Mukau', club: 'Lille', caps: 6 },
      { name: 'Nathanaël Mbuku', club: 'Montpellier', caps: 8 },
      { name: 'Brian Cipenga', club: 'Castellón', caps: 4 },
    ],
    forwards: [
      { name: 'Yoane Wissa', club: 'Newcastle United', caps: 28 },
      { name: 'Cédric Bakambu', club: 'Real Betis', caps: 60 },
      { name: 'Fiston Mayele', club: 'Pyramids FC', caps: 18 },
      { name: 'Simon Banza', club: 'Al Jazira', caps: 15 },
      { name: 'Théo Bongonda', club: 'Spartak Moscow', caps: 30 },
