export const translations = {
  'pt-PT': {
    ...
    avatarUploadBtn: 'Carregar foto',
    avatarUploading: 'A carregar...',
    avatarRemoveBtn: 'Sem avatar',
    avatarErrorType: 'Escolhe um ficheiro de imagem.',
    avatarErrorUpload: 'Falha ao carregar a imagem. Tenta outra.',
    avatarGoat: 'GOAT',
    avatarKing: 'O Rei',
    avatarKeeper: 'O Guardião',
    avatarCaptain: 'O Capitão',
    avatarRocket: 'O Foguete',
    avatarMaestro: 'O Maestro',
    avatarScorer: 'O Goleador',
    avatarGem: 'A Joia',
    avatarLightning: 'O Relâmpago',
    avatarWall: 'O Muro',
    avatarMagician: 'O Mágico',
    avatarEagle: 'A Águia',
    avatarFlame: 'O Craque',
  ...
  'en-GB': {
    ...
    avatarErrorType: 'Pick an image file.',
    avatarErrorUpload: 'Upload failed. Try another image.',
    avatarGoat: 'GOAT',
    avatarKing: 'The King',
    avatarKeeper: 'The Keeper',
    avatarCaptain: 'The Captain',
    avatarRocket: 'The Rocket',
    avatarMaestro: 'The Maestro',
    avatarScorer: 'The Scorer',
    avatarGem: 'The Gem',
    avatarLightning: 'The Lightning',
    avatarWall: 'The Wall',
    avatarMagician: 'The Magician',
    avatarEagle: 'The Eagle',
    avatarFlame: 'The Star Man',
    avatarStar: 'The Star',
    avatarBull: 'The Bull',
    avatarBall: 'Footy',
